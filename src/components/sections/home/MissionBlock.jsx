...
const MissionBlock = () => {
  ...
  useGSAP(
    () => {
      ...
      tl.fromTo(
        ...
        // Stagger Content elements from the right/bottom
        .fromTo(
          ".mission-item",
          { y: 30, opacity: 0 },
          {
  ...
  return (
    ...
    >
      <div className="max-w-[1260px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        {/* Left Column: Image Area */}
        <div className="mission-image relative w-full rounded-[36px] overflow-hidden bg-[#F0F5FB] aspect-square lg:aspect-[9/10] max-h-[640px] order-2 lg:order-1">
        ...
        <div className="flex flex-col items-start order-1 lg:order-2">
          ...
          <h2 className="mission-item mt-4 mb-6 text-[#060D1A] text-4xl md:text-5xl lg:text-[50px] font-extrabold font-sora leading-[1.1]">
            Building Roads That <br className="hidden md:block" /> Build Trust.
          </h2>

          <p className="mission-item mb-10 text-[#586474] text-base md:text-lg font-jakarta leading-relaxed max-w-[500px]">
          ...
          <div className="flex flex-col gap-6 w-full max-w-[500px]">
            {missionFeatures.map((feature, index) => (
              <div key={index} className="mission-item flex items-start gap-4">
                ...
                {/* Text Content */}
                <div>
                  <h4 className="text-[#060D1A] text-base font-semibold font-jakarta leading-tight mb-1">
                    {feature.title}
                  </h4>
                  <p className="text-[#586474] text-sm font-normal font-jakarta leading-relaxed">
                    {feature.desc}
                  </p>
                </div>
              </div>
          ...
          <Link
            to="/about"
            className="mission-item mt-10 group flex items-center gap-2 text-brand-amber text-sm font-semibold font-jakarta hover:text-amber-500 transition-colors"
          >
